...
#ifndef ghexportmodule_h
#define ghexportmodule_h
...
//@{
#define _IFT_GHExportModule_Name "gh"
#define _IFT_GHExportModule_divisions "divisions"
//#define _IFT_GHExportModule_stype "stype"
//#define _IFT_GHExportModule_regionstoskip "regionstoskip"
//@}
 ...
 */
class OOFEM_EXPORT GHExportModule : public ExportModule
{   
protected:
  // number of segments
  int divisions = {10};
...
public:
    ...
    GHExportModule(int n, EngngModel * e);
    /// Destructor
    virtual ~GHExportModule();
    ...
    virtual const char *giveClassName() const { return "GHExportModule"; }
